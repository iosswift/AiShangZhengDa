...
private let kSelectColor : (CGFloat, CGFloat, CGFloat) = (0, 0, 255)
...
class PageTitleView: UIView {
   ...
   //MARK:-懒加载属性
    ...
    public lazy var scrollView : UIScrollView = {
        ...
        scrollView.frame = CGRect(x: 140, y: 0, width: 110, height: 37)
...
extension PageTitleView{
    ...
    //MARK:-标签设置
    public func setupTitleLabels(){
        
        // 0.确定label的一些frame的值
        let labelW : CGFloat = scrollView.frame.width / CGFloat(titles.count)
        let labelH : CGFloat = scrollView.frame.height - kScrollLineH
    ...
    public func setupBottomLineAndScrollLine() {
        // 1.添加底线
        let bottomLine = UIView()
        bottomLine.backgroundColor = UIColor.lightGray
        let lineH : CGFloat = 0.2
        bottomLine.frame = CGRect(x: 140, y: 34, width: scrollView.frame.width, height: lineH)
