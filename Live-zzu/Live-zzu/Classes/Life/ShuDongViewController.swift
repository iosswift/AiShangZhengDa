...
class ShuDongViewController: UIViewController,UITableViewDelegate, UITableViewDataSource  {
    ...
    override func viewDidLoad() {
        ...
        let button = UIButton(frame:CGRect(x: 280, y: 530, width: 100, height: 100))
        button.setBackgroundImage(UIImage(named:"pub_tree"),for:.normal)
        //创建表视图
        ...
        //创建一个重用的单元格
        self.tableView!.register(UINib(nibName:"shudongTableViewCell", bundle:nil),
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath)-> UITableViewCell{
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell")as! shudongTableViewCell
