...
class xinxiViewController: UIViewController,ChatDataSource,UITextFieldDelegate  {
    ...
    func setupSendPanel()
    {
        ...
        let sendView = UIView(frame:CGRect(x: 0,y: self.view.frame.size.height - 105,width: screenWidth,height: 56))
        ...
        sendButton.addTarget(self, action:#selector(xinxiViewController.sendMessage) ,
