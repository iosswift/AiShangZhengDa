//
//  ZhaoHuiMiMaViewController.swift
//  Live-zzu
//
...
class ZhaoHuiMiMaViewController: UIViewController ,UITextFieldDelegate{
    ...
    override func viewDidLoad() {
        ...
        let textField2 = UITextField(frame: CGRect(x: 30, y: 250, width: 300, height: 36))
        let textField3 = UITextField(frame: CGRect(x: 30, y: 320, width: 300, height: 36))        //设置边框样式为圆角矩形
        ...
        let line2 = UIView(frame: CGRect(x: 0, y: 35, width: textField1.frame.width, height: textField1.frame.height * 1 / 40))
        line2.backgroundColor = UIColor.lightGray
        
        
        let line3 = UIView(frame: CGRect(x: 0, y: 35, width: textField1.frame.width, height: textField1.frame.height * 1 / 40))
        ...
        //按钮的文字设置
        button1.setTitle("确定", for:.normal) //普通状态下的文字
        ...
        button1.addTarget(self, action:#selector(actionBack), for:.touchUpInside)
